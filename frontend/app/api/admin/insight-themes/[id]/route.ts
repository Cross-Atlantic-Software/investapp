...
export async function GET(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const response = await fetch(`${API_BASE_URL}/backend/api/admin/insight-themes/${id}`, {
      method: "GET",
      headers: {
    ...
    return NextResponse.json(
      { success: false, message: "Failed to fetch insight theme" },
      { status: 500 }
    );
  }
}
...
export async function PUT(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    return NextResponse.json(
      { success: false, message: "Failed to update insight theme" },
      { status: 500 }
    );
  }
}
...
export async function DELETE(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    return NextResponse.json(
      { success: false, message: "Failed to delete insight theme" },
      { status: 500 }
    );
  }
}
