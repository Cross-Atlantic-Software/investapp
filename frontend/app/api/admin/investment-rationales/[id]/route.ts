...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json(
      { success: false, message: 'Failed to fetch investment rationale' },
      { status: 500 }
    );
  }
}

// Update a specific investment rationale
export async function PUT(
  ...
  try {
    ...
    return NextResponse.json(
      { success: false, message: 'Failed to update investment rationale' },
      { status: 500 }
    );
  }
}

// Delete a specific investment rationale
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json(
      { success: false, message: 'Failed to delete investment rationale' },
      { status: 500 }
    );
  }
}
