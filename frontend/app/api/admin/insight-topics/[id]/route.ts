...
export async function GET(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const response = await fetch(`${API_BASE_URL}/backend/api/admin/insight-topics/${id}`, {
      method: "GET",
      headers: {
    ...
    return NextResponse.json(
      { success: false, message: "Failed to fetch insight topic" },
      { status: 500 }
    );
  }
}
...
export async function PUT(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    return NextResponse.json(
      { success: false, message: "Failed to update insight topic" },
      { status: 500 }
    );
  }
}
...
export async function DELETE(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    return NextResponse.json(
      { success: false, message: "Failed to delete insight topic" },
      { status: 500 }
    );
  }
}