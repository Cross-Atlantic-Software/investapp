...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    const userRelatedPages = ['/admin/users', '/admin/site-users', '/admin/user-portfolios', '/admin/enquiries', '/admin/subscribers', '/admin/buy-requests'];
...
function Sidebar({
  ...
  return (
      ...
      <nav className="flex-1 px-4 py-6 lg:py-8 space-y-3 overflow-y-auto">
          ...
          <NavLink
                    href="/admin/stock-performance-scores"
            active={pathname === '/admin/stock-performance-scores'}
            icon={
                      <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                      </svg>
            }
            label="Stock Performance Scores"
          />
          ...
          {/* Users accordion */}
            ...
            >
              <div className="ml-4 mt-2 space-y-1">
                ...
                />
                <SubLink
                  href="/admin/user-portfolios"
                  active={pathname === '/admin/user-portfolios'}
                  icon={
          ...
          <NavLink
            ...
            active={pathname === '/admin/market-insights'}
            icon={
                      <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <NavLink
                    href="/admin/knowledge-centers"
            active={pathname === '/admin/knowledge-centers'}
            icon={
                      <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <NavLink
                    href="/admin/home-insights"
            active={pathname === '/admin/home-insights'}
            icon={
                      <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <NavLink
            href="/admin/contact-faqs"
            active={pathname === '/admin/contact-faqs'}
            icon={
              <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
                  strokeLinecap="round"
