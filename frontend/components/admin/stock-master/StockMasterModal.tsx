          ...
          <div className="space-y-4">
            ...
            {stockMasters.length === 0 ? (
              <div className="text-center py-16 min-h-[400px] flex flex-col items-center justify-center">
                ...
                <h3 className="text-lg font-medium text-themeTeal mb-2">No stock tags found</h3>
                <p className="text-sm text-themeTealLighter">Get started by adding a new stock tag.</p>
              </div>
            ) : (
