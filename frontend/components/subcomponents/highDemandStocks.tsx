...
export default function HighDemandStocks({
      ...
      <div>
        ...
        <div className="mb-4 flex flex-wrap items-center gap-3">
          <h3 className="flex items-center gap-2 text-lg font-semibold text-themeTeal">
            <TrendingUp className="stroke-green-800" />
            {title}
          </h3>
          <span className="rounded-full bg-green-800 px-2 py-0.5 text-xs text-themeTealWhite">
            {items.length} Stocks
          </span>
        </div>
